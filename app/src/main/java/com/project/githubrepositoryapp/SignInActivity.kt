...
import com.project.githubrepositoryapp.databinding.ActivitySignInBinding
import com.project.githubrepositoryapp.utility.AuthTokenProvider
    ...
    private suspend fun getAccessToken(code: String) = withContext(Dispatchers.IO) {
        ...
        if (response.isSuccessful) {
            ...
            if (accessToken.isNotEmpty()) {
                ...
                Toast.makeText(this@SignInActivity, "accessToken이 존재하지 않습니다.", Toast.LENGTH_LONG).show()
            }
        }
    }
}